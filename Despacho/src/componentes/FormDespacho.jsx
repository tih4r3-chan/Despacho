...
export const FormDespacho = ({ venta, onClose }) => {
  ...
  return (
    <>
      ...
      >
        <div className="mx-auto text-3xl font-bold mb-10 text-teal-500/80 ">
        ...
        <button
          className="py-6 px-14 rounded-lg bg-teal-500/80 hover:bg-teal-600 text-white font-bold mb-14"
          type="submit"
        >
          Asignar despacho
        </button>
